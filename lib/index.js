...
var anyleadsModule = (function() {
  var Anyleads = function(apiKey) {
  ...
  Anyleads.prototype.getPattern = function(domain) {
  ...
  Anyleads.prototype.verifyEmail = function(email) {
  ...
  Anyleads.prototype.searchDomainEmails = function(domain) {
  ...
  Anyleads.prototype.getPersonalEmail = function(domain, identity) {
